...
class Config:
    ...
    #: המשפט שבמסגרת, בין הפסוק לתיבת השאלה. תפקידו להסביר לגולש שהגיע
    #: לראשונה מה הוא מקבל כאן, לפני שהוא מקליד. משפט אחד, כדי שייפול
    #: לשתי שורות מאוזנות במסגרת.
    HOME_LEDE = (
        "מאגר הלכה ויהדות בעברית פשוטה עם תשובות קצרות, "
        "מקורות והסברים מעשיים."
    )

...
class Config:
    ...
    #: הנתיבים הסטטיים נושאים ?v=mtime דרך ``static_v``, ולכן אפשר לשמור
    #: אותם במטמון לאורך זמן. שני החלקים חייבים להישאר יחד — בלי ``static_v``
    #: מטמון של שנה יקפיא CSS ישן אצל המשתמש.
